...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        self.text_encoder.tec.bias.data = torch.tensor([-5., 0.])
#         self.text_encoder.tec.load_state_dict(torch.load('tec.pt'))
        ...
        self.text_encoder_m = BertTECModel.from_pretrained(text_encoder, config=bert_config,
                                                           add_ted_head=config['add_ted_head'],
                                                           add_mlm_head=config['add_mlm_head'])
        self.text_encoder_m.tec.bias.data = torch.tensor([-5., 0.])
...
#         pdb.set_trace()
        ...
        _, loss_det = self.text_encoder(text.rep_token_ids,
                                        attention_mask=text.attention_mask,
