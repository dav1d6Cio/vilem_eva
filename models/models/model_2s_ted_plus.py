...
from models.bert_ted_last import BertConfig, BertTECModel
...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        ted_backbone = BertTECModel.from_pretrained(text_encoder, config=bert_config,
                                                         add_ted_head=config['add_ted_head'],
                                                         add_mlm_head=config['add_mlm_head'])
        self.ted_backbone = nn.ModuleList([ted_backbone.bert.encoder.layer[10], ted_backbone.bert.encoder.layer[11]])
...
#         pdb.set_trace()
        ...
        mlm_output, loss_det = self.text_encoder(text.rep_token_ids,
                                       ...
                                       alpha=alpha,
                                       ted_backbone=self.ted_backbone
                                       )
