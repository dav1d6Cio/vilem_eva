...
class ALBEF(nn.Module):
    ...
    def forward(self, image, text, alpha=0, idx=None, beta=1.):
        ...
        # margin loss between positive text and negative text
        margin = 0.02
        ...
        return {'loss_ita': loss_ita, 'loss_tec': loss_mlm * beta, 'loss_det': loss_det * self.lambda_ted * beta, 'loss_inter': loss_neg}
