...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        self.text_encoder = BertTECModel.from_pretrained(text_encoder, config=bert_config,
                                                         ...
                                                         add_mlm_head=config[
                                                             'add_mlm_head'] if 'add_ted_head' in config.keys() else False)
...
#         pdb.set_trace()
        ...
        loss_mlm = (loss_mlm1 + loss_mlm2 + loss_mlm3 + loss_mlm4) / 2.
        loss_det = (loss_det1 + loss_det2 + loss_det3 + loss_det4) / 2.

        return {'loss_ita': loss_ita, 'loss_tec': loss_mlm * beta, 'loss_det': loss_det * self.lambda_ted * beta}
