...
from models.bert_blip_wo_ca import BertConfig, BertForMaskedLM
...
#         pdb.set_trace()
        ...
        mlm_output1 = self.text_encoder(input_ids,
        ...
        mlm_output2 = self.text_encoder_m(input_ids,
                                       attention_mask=text.attention_mask,
        ...
        return {'loss_ita': loss_ita, 'loss_mlm': loss_mlm}
