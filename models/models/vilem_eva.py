...
from eva_clip.eva_clip import create_model
...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        self.visual_encoder = create_model(config['vit_name'], config['vit_weights'], force_custom_clip=True).visual
        ...
        self.visual_encoder_m = create_model(config['vit_name'], config['vit_weights'], force_custom_clip=True).visual
