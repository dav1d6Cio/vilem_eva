...
from models.bert_blip1 import BertForMaskedLM
...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        bridge_config = BertConfig.from_json_file('configs/config_bridge.json')
        self.bridge = BertForMaskedLM.from_pretrained(text_encoder, config=bridge_config)
        # tie weights of bridge and text encoder
        self.bridge.bert.embeddings.word_embeddings.weight = self.text_encoder.embeddings.word_embeddings.weight
        ...
        self.bridge_m = BertForMaskedLM.from_pretrained(text_encoder, config=bridge_config)
    ...
    def forward(self, image, text, alpha=0, idx=None):
        ...
        #
        with torch.no_grad():
            logits_m = self.bridge_m(input_ids,
        ...
        mlm_output = self.bridge(input_ids,
                                   attention_mask=text.attention_mask,
