...
#         sim_i2w = torch.cat([sim_i2w, sim_i2t[:, batch_size:]], dim=1)  # N,L-1+queue_size
        # neg_tau，用于提升错误词汇的分数，使得loss_i2w更大，i2w对模型的影响更大
        neg_tau = torch.ones_like(sim_i2w_targets)
        neg_tau[sim_i2w_targets==0] = 2.
