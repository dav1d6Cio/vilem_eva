...
from loss.loss_objects_image import matching_contrastive_loss
import torch
...
class ALBEF(nn.Module):
    ...
    def forward(self, image, image_aug, text, alpha, idx):
        ...
        loss_o2o = matching_contrastive_loss(torch.cat([obj_feat, obj_feat_m], dim=0), 0.1) / 2.

        loss_ita = (loss_i2t + loss_t2i) / 2

        self._dequeue_and_enqueue(image_feat_m, text_feat_m, idx)

        return loss_ita, loss_o2o
