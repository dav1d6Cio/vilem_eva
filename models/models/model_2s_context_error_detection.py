...
#         bert_config.fusion_layer = 12
    ...
    def forward(self, image, text, alpha=0, idx=None, beta=1.):
        ...
        v_rep_text_embeds = self.text_encoder(text.rep_token_ids,
        ...
        v_rep_text_embeds_m = self.text_encoder_m(text.rep_token_ids,
                                                attention_mask=text.attention_mask,
        ...
        bce_logits = torch.matmul(rep_text_embeds_m.unsqueeze(-2), v_rep_text_embeds.unsqueeze(-1)).squeeze() # N,L
