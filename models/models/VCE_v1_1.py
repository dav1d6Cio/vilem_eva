...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        self.vct = VcTModel.from_pretrained(text_encoder, config=vct_config, num_queries=1)
    ...
    def forward(self, image, text, alpha, idx):
        ...
        text_output = self.text_encoder(text.input_ids, attention_mask=text.attention_mask, return_dict=True, mode='text', output_hidden_states=True)
