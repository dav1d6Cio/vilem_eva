...
def resize_vilem_pos_embed(pos_embed_checkpoint, visual_encoder, interpolation: str = 'bicubic', seq_dim=1):
    # interpolate position embedding
    embedding_size = pos_embed_checkpoint.shape[-1]
